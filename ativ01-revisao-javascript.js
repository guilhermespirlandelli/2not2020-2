...
for(let i = 0; i < estadosNe.length; i++) {
    estadosNe[i]["Densidade demográfica: "] = densidade(estadosNe[i].populacao, estadosNe[i].area)
...
for(let percorrer of estadosNe) {
    propriedades(percorrer) 
}
...
vetorVazio.push(estado1.nome)
vetorVazio.unshift(estado2.nome)
vetorVazio.splice(1, 0, estado3.nome)
vetorVazio.splice(1, 0, estado4.nome)
vetorVazio.splice(2, 0, estado5.nome)
vetorVazio.splice(1, 0, estado6.nome)
vetorVazio.splice(4, 0, estado7.nome)
vetorVazio.splice(2, 0, estado8.nome)
vetorVazio.splice(1, 0, estado9.nome)
