/*
    ...
    e promovendo a troca quando o sucessor é maior que antecessor.

    O percurso no vetor é feito quantas vezes necessário, até 
...
*/
 ...
 /*let empresas = require('./dados/15-mil-empresas (1)')

 console.time('Teste empresas')
 bubbleSort(empresas)
 console.timeEnd('Teste empresas')*/

 let nomes = require('./dados/100-mil-nomes (1)')
